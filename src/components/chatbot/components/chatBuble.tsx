      ...
      >
        {isLoading ? (
          ...
          <ReactMarkdown remarkPlugins={[remarkGfm]}
            components={{ 
              p: ({ ...props }) => <p className="text-xs text-gray-700 leading-relaxed text-justify hyphens-auto" {...props} />,
              li: ({ ...props }) => <li className="text-xs text-gray-700 leading-relaxed" {...props} />,
              a: ({ ...props }) => <a className="text-xs text-sky-500 leading-relaxed" {...props} target='_blank'/>,
            }}>
            {chat}
          </ReactMarkdown>
        )}
